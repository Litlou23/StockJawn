...
export const config = {
  matcher: [
    '/((?!approve|history|api/approve|api/jobs/run-weekly-research|_next/static|_next/image|favicon\\.ico|robots\\.txt|sitemap\\.xml|.*\\.(?:png|jpg|jpeg|gif|webp|svg|ico|css|js)$).+)',
  ],
};
