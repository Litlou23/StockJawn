...
public class DailyResearchRunService
{
    ...
    public async Task<MorningScanResult> RunMorningScanAsync(string? existingRunId = null, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            // ── Setup scanners removed ──
            // EMA Pullback, VWAP Reclaim, Bull Flag, Range Contraction Breakout, Volume Shelf Bounce
            // all disabled — accuracy was poor (0-30%) and volume negligible (30 total out of 1,750).
            // Keeping only profile-based predictions (Catalyst Momentum, Risk-Adjusted, Data-Driven Scalper).
            _logger.LogInformation("[research-engine] Setup scanners disabled — profile predictions only");
